$(function () {
  ...
  var e = $(".user-list-table"),
    ...
    n = "../../../app-assets/",
    l = "app-user-view.html",
    r = "app-user-edit.html";
      ...
      e.DataTable({
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (e, t, a, s) {
              return (
                '<div class="btn-group"><a class="btn btn-sm dropdown-toggle hide-arrow" data-toggle="dropdown">' +
                feather.icons["more-vertical"].toSvg({
                  class: "font-small-4",
                }) +
                '</a><div class="dropdown-menu dropdown-menu-right"><a href="' +
                l +
                '" class="dropdown-item">' +
                ...
                'Edit</a><a href="javascript:;" class="dropdown-item delete-record">' +
        ...
        buttons: [
          {
            ...
            attr: { "data-toggle": "modal", "data-target": "#modals-slide-in" },
            init: function (e, t, a) {
